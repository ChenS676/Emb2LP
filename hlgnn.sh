...
#SBATCH --chdir=/hkfs/work/workspace_haic/scratch/cc7738-TAGBench/Emb2LP/OGB/res_outputs
...
if [ "$1" == "planetoid" ]; then
    cd Planetoid
    python3 planetoid_grid.py --dataset cora --runs 1 --norm_func gcn_norm --mlp_num_layers 3 --hidden_channels 8192 --dropout 0.5 --epochs 100 --K 20 --alpha 0.2 --init RWR
