...
import torch
import csv
from dataloaders.load_data_nc import (load_tag_cora, 
                                     load_tag_pubmed, 
                                     load_tag_product, 
                                     load_tag_ogbn_arxiv,
                                     load_tag_product, 
                                     ...
                                     load_tag_citeseer,
                                     load_tag_citationv8,)
from dataloaders.load_data_lp import (load_taglp_arxiv2023, 
                                    load_taglp_cora, 
                                    load_taglp_pubmed, 
                                    load_taglp_product, 
...
from dataloaders.load_data_lp import (load_graph_cora, 
                                     load_graph_arxiv23,
